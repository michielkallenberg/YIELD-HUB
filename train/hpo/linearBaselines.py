...
--------------------
Author: XYZ
Description: A linear architecture based crop yield prediction framework with Optuna Hyperparameter Optimization.
...
# Quick test run (2 trials)
    python linearBaselines.py --crop wheat --country NL --model_type nlinear --n_trials 2 --epochs 2 --results_dir checkpoints-test/results
