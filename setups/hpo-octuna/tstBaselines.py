...
# Quick test run (2 trials)
    python tstBaselines.py --crop wheat --country NL --model_type informer --n_trials 4 --epochs 2 --results_dir checkpoints-test/results --data_fraction 1.0 --aggregation daily
